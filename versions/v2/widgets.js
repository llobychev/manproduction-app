export const WIDGET_CATALOG = Object.freeze([
  Object.freeze({id:'tasks',title:'Дела',icon:'✅',category:'tasks',description:'Сегодня, ближайшие и просроченные дела',route:'schedule.today',dataSource:'user_data.schedules + events',sizes:['small','medium','large']}),
  Object.freeze({id:'calendar',title:'Календарь',icon:'📅',category:'calendar',description:'Даты, дела и ближайшие события',route:'schedule.today',dataSource:'user_data.schedules + events',sizes:['small','medium','large']}),
  ...
  Object.freeze({id:'finance',title:'Финансы',icon:'💰',category:'finance',description:'Доходы, расходы и цели',route:'widgets.finance',legacyRoute:'fin',dataSource:'user_data.finance',sizes:['small','medium','large']}),
  Object.freeze({id:'relationships',title:'Отношения',icon:'🤝',category:'relationships',description:'Знакомства, общение и отношения',route:'widgets.relationships',sizes:['small','medium','large']}),
  Object.freeze({id:'earnings',title:'Заработок',icon:'📈',category:'earnings',description:'Работа, дополнительный доход и рост заработка',route:'widgets.earnings',sizes:['small','medium','large']}),

...
export const EXTERNAL_ACCEPTANCE_GATES = Object.freeze([
  ...
  Object.freeze({ id:'telegram-real-device-responsive-proof', status:'pending', evidence:'Requires owner-accessible Telegram V0.1 preview on target devices.' }),
  ...
  Object.freeze({ id:'v1-v0.1-v1-controlled-rollback', status:'pending', evidence:'Requires a controlled activation test only after the V0.1 preview is accepted.' }),
